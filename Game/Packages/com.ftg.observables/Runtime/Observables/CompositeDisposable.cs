...
namespace FTg.Common.Observables
{
    ...
    public sealed class CompositeDisposable : ICollection<IDisposable>, IDisposable
    {
                ...
                if (!_disposed)
                {
                    ...
                    if (i >= 0)
                    {
                        ...
                        if (_disposables.Capacity > SHRINK_THRESHOLD && Count < _disposables.Capacity / 2)
                        {
                            ...
                            foreach (var d in old.Where(d => d != null))
                                _disposables.Add(d);
                        }
                    }
                }
        ...
        public void Dispose()
        {
            ...
            if (currentDisposables == null) return;
        ...
        public void CopyTo(IDisposable[] array, int arrayIndex)
        {
            ...
            lock (_gate)
            {
                Array.Copy(_disposables.Where(item => item != null).ToArray(), 0, array, arrayIndex, array.Length - arrayIndex);
            }
        }
        ...
        public IEnumerator<IDisposable> GetEnumerator()
        {
            ...
            lock (_gate)
            {
                res.AddRange(_disposables.Where(d => d != null));
            }
